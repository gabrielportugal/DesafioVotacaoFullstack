...
export const TopicInfoModal: React.FC<TopicInfoModalProps> = ({
  ...
  return (
    <BootstrapModal show={isOpen} onHide={handleClose} centered size="xl">
      ...
      <BootstrapModal.Body style={styles.modalBody}>
        ...
        {!loading && !error && topic && (
          <div style={styles.modalContent}>
            {/* Coluna da Esquerda: Título, Badge, Descrição e Resultado */}
            ...
            {/* Coluna da Direita: Abrir Sessão e Lista de Sessões */}
